...
$reqe = $db->prepare('SELECT * FROM paiement where id=?');
...
if(isset($_POST['supprimer'])){
    ...
    $req = $db->prepare('DELETE FROM paiement where id=?');
    $req->execute(array($_SESSION['id']));
    header("location:samaffich_paiement.php?message=message");
...
<![endif]-->
    ...
    while ($donnees = $reqe->fetch()){
        echo"<form method=post action=samaffich2_paiement.php>";
        ...
        echo"<td>"."<input class=form-control readonly type=double name=nfich_paie value=".$donnees['nfich_paie'] ." >";echo"</td>";
    ...
    $donnees = $req->fetch(); ?>
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <td>ID ENG</td>
                                    <td><?php echo $donnees['id_eng'];?></td>
                                </tr>

                                <tr>
                                    <td>OBJET PAIE</td>
                                    <td><?php echo $donnees['objet_paie'];?></td>
                                </tr>

                                <tr>
                                    <td>NUM FICHE PAIE</td>
                                    <td><?php echo $donnees['nfich_paie'];?></td>
                                </tr>

                                <tr>
                                    <td>STRUCTURE PAIE</td>
                                    <td><?php echo $donnees['structure_paie'];?></td>
                                </tr>
        ...
        <div class="modal fade" id="detailModal" role="dialog" aria-labelledby="detailModal1" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
					...
					echo"<form method=post action=modif4_paiement.php>";
					echo"<p>";
					echo"<label for=id >Id</label> :"; 
					echo"<input class=form-control type=text name=id id=id required=yes value=".$donnee['id']." >";
					echo"</p>";
					
					echo"<p>";
					echo"<label for=id_eng>Id_engt</label> :"; 
					echo"<input class=form-control type=text name=id_eng id=id_eng required=yes value=".$donnee['id_eng']." >";
					echo"</p>";

					echo"<p>";
					echo"<label for=ooperation>Objet du paiement</label> :"; 
					echo"<input class=form-control type=text name=objet_paie id=ooperation required=yes value=".$donnee['objet_paie']." >";
					echo"</p>";

					echo"<p>";
					echo"<label for=nengagement>N°fiche du paiement</label> :"; 
					echo"<input class=form-control type=number name=nfich_paie id=nengagement required=yes value=".$donnee['nfich_paie']." >";
					echo"</p>";

					echo"<p>";
					echo"<label for=sengagement>Structure dengagement proposé</label> :"; 
					echo"<input class=form-control type=text name=structure_paie id=sengagement required=yes value=".$donnee['structure_paie']." >";
					echo"</p>";
