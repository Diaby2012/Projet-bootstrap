...
$req = $db->query('SELECT * FROM engagement where ods="ok" ');
?>
<!DOCTYPE html>
<html lang="fr">
...
<table  class="table table-bordered">
			 ...
			 echo"<form method=post action=pdf/ods.php>";
			 echo"<tr class=text-center>";
                ...
                echo"<td>"."<a class='btn btn-default' href=ods.php?id=".$donnees['id'].">";echo"Détail<span class='fa fa-plus fa-fw'</a></td>";				
				echo"<td>"."<button class='btn btn-success'  type=submit name=envoyer>IMPRIMER<span class='fa fa-send fa-fw'></span></button>"; echo"</td>";
			 echo"</tr>";
			echo "</form>";
			  }}?>
		</table>
