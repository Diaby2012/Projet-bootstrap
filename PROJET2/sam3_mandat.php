            ...
            <div class="row">
                <div class="panel panel-primary" id="panel_pad">
                    <div class="panel-heading">
                        <h1 class="panel-title">Formulaire de creation d'un mandat:</h1>
                    </div>
                    <div class="panel-body">
                        <div class="col-xs-6 col-xs-offset-3 form-enga">
                            <form id="mandaf" method="POST" action="sam4_mandat.php">
                                <h3 class="bord">Info Mandat</h3>
                                <hr>
                                <div class="left-col">
                                    <div class="form-group">
                                        <label for="num_op">Num operation</label> :
                                        <input class="form-control" type="text" name="num_op" readonly id="num_op" value="<?php echo $_SESSION['num_op']?>"  />
                                    </div>

                                    <div class="form-group">
                                        <label for="nom">Nom entreprise</label> :
                                        <input class="form-control" type="text" name="nom" readonly id="nom" value="<?php echo $_POST['nom']?>" />
                                    </div>
                                </div>
                                <div>
                                    <div class="form-group">
                                        <label for="num_compte">Num de compte</label> :
                                        <input class="form-control" type="text" name="num_compte" readonly id="nfich_paie" value="<?php echo $_POST['num_compte']?>" />
                                    </div>
