...
$req = $db->query('SELECT * FROM engagement where verdict="" ');
?>
<!DOCTYPE html>
<html lang="fr">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
			<div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="cf_page.php">CF - Admin Page</a>
                </div>
...
<div class="col-lg-12">
    <?php if(isset($_GET['message'])){ ?>
				  ...
				  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				   <strong>Yeah !</strong> Votre Verdicte a été inseré avec succes ! <i class="fa fa-info-circle"></i>
					</div>
					<?php }?>
<table  class="table table-bordered">
			 ...
			 echo"<form method=post action=acceuil2_cf.php>";
			 echo"<tr class=text-center>";
                ...
                echo"<td>"."<a class='btn btn-default' href=cf_page.php?id=".$donnees['id'].">";echo"Détail<span class='fa fa-plus fa-fw'</a></td>";				
		        echo"<td>"."<select class=form-control name=verdict> <option  value=valider>VALIDER</option> <option value=rejeter>REJETER</option> </select>"; echo"</td>";
				echo"<td>"."<button class='btn btn-success'  type=submit name=envoyer>ENVOYER<span class='fa fa-send fa-fw'></span></button>"; echo"</td>";
			 echo"</tr>";
			echo "</form>";
			  }}?>
		</table>
