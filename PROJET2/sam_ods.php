...
$req = $db->query('SELECT * FROM engagement where verdict="valider" and approbation="approuver" and ods=""  ');

if(isset($_POST['creer'])){
	$_SESSION['id_eng']=$_POST['id'];
	header("location:sam2_ods.php");
}
?>
<!DOCTYPE html>
<html lang="fr">
...
<?php if(isset($_GET['message'])){ ?>
         ...
         <div class="alert alert-success alert-dismissible monalert" role="alert">
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                       <strong>Yeah !</strong> Votre ODS a été crée avec succes ! <i class="fa fa-info-circle"></i>
                        </div>
                        <?php }?>
<table  class="table table-bordered">
			 ...
			 echo"<form method=post action=sam_ods.php>";
			 echo"<tr class=text-center>";
				...
				echo"<td>"."<button class='btn btn-success'  type=submit name=creer >CREER<span class='fa fa-send fa-fw'></span></button>"; echo"</td>";
			 echo"</tr>";
			echo "</form>";
			  }}?>
		</table>
