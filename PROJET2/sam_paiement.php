...
<table  class="table table-bordered">
			 ...
			 echo"<form method=post action=sam_paiement.php>";
			 echo"<tr class=text-center>";
                ...
                echo"<td>"."<a class='btn btn-default' href=sam_paiement.php?id=".$donnees['id'].">";echo"Détail<span class='fa fa-plus fa-fw'</a></td>";				
