...
$req = $db->query('SELECT * FROM engagement where approbation="" and verdict="valider" ');
...
<html lang="fr">
    ...
    <head>
        ...
        <title>Directeur - Page d'Administration</title>
        <!-- Bootstrap -->
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
               <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="directeur_page.php">DG - Admin Page</a>
                </div>
...
<div class="col-lg-12">
       <?php if(isset($_GET['message'])){ ?>
				  ...
				  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				   <strong>Yeah !</strong> Votre Approbation a été inseré avec succes ! <i class="fa fa-info-circle"></i>
					</div>
					<?php }?>
<table  class="table table-bordered">
			 ...
			 echo"<form method=post action=acceuil2_dg.php>";
			 echo"<tr class=text-center>";
                ...
                echo"<td>"."<a class='btn btn-default' href=directeur_page.php?id=".$donnees['id'].">";echo"Détail<span class='fa fa-plus fa-fw'</span></a></td>";
				echo"<td>"."<button class='btn btn-success'  type=submit name=approuver>APPROUVER<span class='fa fa-send fa-fw'></span></button>"; echo"</td>";
			 echo"</tr>";
			echo "</form>";
			  }}?>
		</table>
