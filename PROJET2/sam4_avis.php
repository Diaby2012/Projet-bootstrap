...
<div style="border-top: 1px solid black; position:relative; width: 960px; margin: 0 auto; ">
    <div style="width: auto; margin:auto; position:relative; ">
        ...
        <div style="width:300px; display:inline-block; margin-left:140px; ">
            ...
            <p>de Dépense Imputable au Budget d"Etat</p>
        </div>
    </div>
    ...
    <table style="clear:both; width:960px; margin:auto; border-collapse: collapse;">
        <tr>
        ...
        <tr>
            ...
            <th style="border:1px solid black;">d"Engag.</th>
        ...
        <tr height="200px" style="vertical-align:top;">
            <td style="border:1px solid black;">'.$_POST['nom'].'</td>
            <td style="border:1px solid black;">'.$_POST['num_compte'].'</td>
            <td style="border:1px solid black;">'.$_POST['montant'].'</td>
            <td style="border:1px solid black;">&nbsp;</td>
            <td style="border:1px solid black;">&nbsp;</td>
            <td style="border:1px solid black;">&nbsp;</td>
            <td colspan="5" style="border:1px solid black;">'.$_POST['num_op'].'</td>
            <td style="border:1px solid black;">&nbsp;</td>
            <td style="border:1px solid black;">&nbsp;</td>
            <td style="border:1px solid black;">&nbsp;</td>
        </tr>
