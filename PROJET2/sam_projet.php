...
if(isset($_POST['selectionner'])){
	...
	header("location:samentreprise_projet.php");
}
...
<html lang="fr">
        ...
        <div class="container">
            <div class="row">
                ...
                <ul class="nav nav-pills nav-justified">
                    <li role="presentation" class="active"><a href="sam_projet.php"><span class="li_men">Afficher</span> <i class="fa fa-pencil-square-o"></i>
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="panel panel-primary" id="panel_pad">
                    ...
                    <div class="panel-body">
                        <p class="policp text-justify"> Sélectionnez l'opération à laquel doit appartenir le projet!</p>
    ...
    while ($donnees = $reqe->fetch()){
        echo"<form method=post action=sam_projet.php>";
